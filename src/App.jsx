...
function MainShopSystem({ showAdmin }) {
  ...
  // กำหนดตัวแปรเดือนให้ถูกต้องตามหลักของ JavaScript
  const now = new Date();
  ...
  const categories = ["Singfiv 20k", "Marbo9000", "Marbo 10k", "Relx go smash 12k", "Relx novo 14k", "Relx Spartar 20k",  "Relx Creator clear 18k", "Infy 20k", "Relx Creator 20k", "M switch 15k", "Marbo 25k", "Esko bar 20k", "Lambo 12k"];
  ...
  // ปรับปรุงฟังก์ชันขาย: เลือกจำนวนชิ้น และแก้ไขราคาขายรวมได้ทันที
